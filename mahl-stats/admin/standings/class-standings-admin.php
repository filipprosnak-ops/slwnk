...
class MAHL_Stats_Standings_Admin
{
	public function render(): void
	{
		...
		if ($selected_season_id > 0) {
			$service = new MAHL_Stats_Standings_Service();
		...
		include MAHL_STATS_PLUGIN_DIR . 'admin/standings/views/list.php';
	}
}